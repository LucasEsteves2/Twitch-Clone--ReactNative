import yodao from '../../images/tumb/yodao.jpg';
import alan from '../../images/tumb/alan.jpg';
...
import alan_perfil from '../../images/avatar/alan_perfil.jpg';
...
const data = [
  { nome: 'alanzoka', img: alan, desc: 'O ano está cababando! ', conteudo: ' Rocket League ', lingua: 'Português', tipo: 'Jogo de corrida/direção', avatar: alan_perfil },
